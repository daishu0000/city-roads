...
<div class='find-place' :class='{centered: boxInTheMiddle }'>
  <div class="settings" v-click-outside="onClickOutsideSettings">
    ...
    <form class="settings-form" @submit.prevent>
      ...
      <label>
        <input type="radio" name="wayFilter" value="intercity" class="settings-radio" v-model="selectedFilterKey">
        Intercity Rail
      </label>
    </form>
  </div>
...
export default {
  ...
  methods: {
    ...
    getSelectedWayFilter() {
      ...
      if (this.selectedFilterKey === 'intercity') return Query.IntercityRail;
      return Query.Road;
    },
